...
- [x] Use semantic labels (where available) in data preview or query-related panels when a semantic model context is active, while still allowing access to underlying view/column names when needed.
