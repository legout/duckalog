...
#### Scenario: All documentation links resolve correctly
- **GIVEN** the documentation site is served with mkdocs
- **WHEN** mkdocs processes all markdown files
- **THEN** no broken link warnings are generated and all internal links work correctly